...
{
  template <typename T>
  struct hash<akrzemi::optional<T>>
  {
    typedef typename hash<T>::result_type result_type;
    typedef akrzemi::optional<T> argument_type;
...
template <typename T>
using CassOptional = std::akrzemi::optional<T>;
constexpr auto CassNullopt = std::akrzemi::nullopt;

}} // namespace datastax::internal

# endif /* OPTIONAL_AKRZEMI_HPP */
